...
export const scira = customProvider({
  languageModels: {
    ...
    'scira-gpt-5-mini-free': isValidApiKey(process.env.AZURE_API_KEY) ? azure.chat('gpt-5-mini') : google('gemini-2.5-flash'),
    'scira-deepseek-v31-free': azureDeepSeekV31.chat('DeepSeek-V3.1'),
    ...
    'scira-deepseek-chat': azure.chat('DeepSeek-R1-0528'),
    'scira-deepseek-chat-think': wrapLanguageModel({
      model: azure.chat('DeepSeek-R1-0528'),
      middleware,
    }),
...
export const models: Model[] = [
  ...
  {
    value: 'scira-grok-4-fast-free',
    label: 'Grok 4 Fast (Azure Free)',
    description: "xAI's Grok 4 Fast model via Azure - Free tier",
    vision: true,
    reasoning: true,
    experimental: false,
    category: 'Free',
  ...
  {
    value: 'scira-gpt-5-mini-free',
    label: 'GPT-5 Mini (Free)',
    description: "OpenAI's GPT-5 Mini via Azure - Free tier",
    vision: true,
    reasoning: true,
    experimental: false,
    category: 'Free',
  ...
  {
    value: 'scira-deepseek-v31-free',
    label: 'DeepSeek V3.1 (Free)',
    description: "DeepSeek's latest reasoning model via Azure - Free tier",
    vision: false,
    reasoning: true,
    experimental: false,
    category: 'Free',
