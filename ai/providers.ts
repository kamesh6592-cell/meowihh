...
export const scira = customProvider({
  languageModels: {
    ...
    'scira-deepinfra-free': isValidApiKey(process.env.DEEPINFRA_API_KEY) ? deepinfra.chat('Qwen/Qwen2.5-72B-Instruct') : google('gemini-2.5-flash'),
    'scira-cerebras-free': isValidApiKey(process.env.CEREBRAS_API_KEY) ? cerebras.chat('deepseek-ai/DeepSeek-V3') : google('gemini-2.5-flash'),
    'scira-fireworks-free': isValidApiKey(process.env.XAI_API_KEY) ? xai('grok-4-fast-non-reasoning') : google('gemini-2.5-flash'),
    ...
    'scira-deepseek-chat': isValidApiKey(process.env.DEEPINFRA_API_KEY) ? deepinfra.chat('deepseek-ai/DeepSeek-V3') : azure.chat('DeepSeek-R1-0528'),
    'scira-deepseek-chat-think': wrapLanguageModel({
      model: isValidApiKey(process.env.DEEPINFRA_API_KEY) ? deepinfra.chat('deepseek-ai/DeepSeek-V3') : azure.chat('DeepSeek-R1-0528'),
      middleware,
    }),
    'scira-deepseek-r1': wrapLanguageModel({
      model: isValidApiKey(process.env.DEEPINFRA_API_KEY) ? deepinfra.chat('deepseek-ai/DeepSeek-R1') : azure.chat('DeepSeek-R1-0528'),
      middleware,
    }),
    ...
    'scira-deepinfra-deepseek-v3': isValidApiKey(process.env.DEEPINFRA_API_KEY) ? deepinfra.chat('deepseek-ai/DeepSeek-V3') : google('gemini-2.5-flash'),
...
export const models: Model[] = [
  ...
  },
  {
    ...
    label: 'Qwen 2.5 72B',
    description: "Alibaba's Qwen 2.5 - Best for coding - DeepInfra $10 credits",
    vision: false,
    reasoning: false,
    experimental: false,
    category: 'Free',
  ...
  },
  {
    ...
    label: 'DeepSeek V3',
    description: "DeepSeek's V3 - Advanced reasoning - Cerebras unlimited free",
    vision: false,
    reasoning: true,
    experimental: false,
    category: 'Free',
  ...
  },
  {
    ...
    label: 'Grok 4 Fast',
    description: "xAI's Grok 4 Fast - General purpose - $25 free xAI credits",
    vision: false,
    reasoning: false,
    experimental: false,
    category: 'Free',
  ...
  // Pro models - DeepSeek (using Azure)
  {
    value: 'scira-deepseek-chat',
    label: 'DeepSeek R1 (Azure)',
    description: "DeepSeek's advanced reasoning LLM via Azure",
    vision: false,
    reasoning: false,
    experimental: false,
    category: 'Pro',
  ...
  },
  {
    ...
    label: 'DeepSeek R1 Thinking (Azure)',
    description: "DeepSeek's advanced reasoning LLM with thinking via Azure",
    vision: false,
    reasoning: true,
    experimental: false,
    category: 'Pro',
  ...
  {
    value: 'scira-deepinfra-deepseek-v3',
    label: 'DeepSeek V3 (DeepInfra)',
    description: "DeepSeek V3 via DeepInfra - Extremely cheap",
    vision: false,
    reasoning: true,
    experimental: false,
    category: 'Pro',
