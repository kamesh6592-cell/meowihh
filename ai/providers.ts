...
export const scira = customProvider({
  languageModels: {
    ...
    // Free tier models - Diversified for different use cases
    ...
    'scira-fireworks-free': isValidApiKey(process.env.FIREWORKS_API_KEY) ? fireworks.chat('accounts/fireworks/models/qwen2p5-coder-32b-instruct') : google('gemini-2.5-flash'),
...
export const models: Model[] = [
  ...
  },
  {
    ...
    description: "Alibaba's Qwen 2.5 72B - Best for coding - $10 free credits",
    vision: false,
    reasoning: false,
    experimental: false,
    category: 'Free',
  ...
  },
  {
    ...
    description: "Meta's Llama 3.1 8B - Ultra-fast lightweight model - Unlimited free",
    vision: false,
    reasoning: false,
    experimental: false,
    category: 'Free',
  ...
  },
  {
    ...
    description: "Alibaba's Qwen 2.5 Coder - Specialized for coding - $10 free credits",
    vision: false,
    reasoning: false,
    experimental: false,
    category: 'Free',
