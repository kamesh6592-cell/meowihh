...
export const scira = customProvider({
  languageModels: {
    ...
    // Free tier models - Best options only
    'scira-deepinfra-free': isValidApiKey(process.env.DEEPINFRA_API_KEY) ? deepinfra.chat('meta-llama/Llama-3.3-70B-Instruct') : google('gemini-2.5-flash'),
    'scira-cerebras-free': isValidApiKey(process.env.CEREBRAS_API_KEY) ? cerebras.chat('llama-3.3-70b') : google('gemini-2.5-flash'),
...
export const models: Model[] = [
  ...
  },
  {
    ...
    description: "Meta's Llama 3.3 via DeepInfra - $10 free credits",
    vision: false,
    reasoning: false,
    experimental: false,
    category: 'Free',
  ...
  },
  {
    ...
    description: "Meta's Llama 3.3 via Cerebras - Fastest inference",
    vision: false,
    reasoning: false,
    experimental: false,
    category: 'Free',
  ...
  },
  {
    ...
    description: "Meta's Llama 3.3 via Fireworks - $10 free credits",
    vision: false,
    reasoning: false,
    experimental: false,
    category: 'Free',
