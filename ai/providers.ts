...
export const scira = customProvider({
  languageModels: {
    ...
    'scira-deepseek-chat': process.env.HF_TOKEN ? huggingface.chat('deepseek-ai/DeepSeek-V3') : groq('llama-3.3-70b-versatile'),
    'scira-deepseek-chat-think': wrapLanguageModel({
      model: process.env.HF_TOKEN ? huggingface.chat('deepseek-ai/DeepSeek-R1') : groq('llama-3.3-70b-versatile'),
      middleware,
    }),
...
export const models: Model[] = [
  ...
  },
  {
    ...
    label: 'DeepSeek 3.2 Exp (Preview)',
  ...
  },
  {
    ...
    label: 'DeepSeek 3.2 Exp Thinking (Preview)',
  ...
  },
  {
    ...
    label: 'Qwen 3 Coder 480B-A35B (Preview)',
  ...
  },
  {
    ...
    label: 'Qwen 3 Next 80B A3B Instruct (Preview)',
  ...
  },
  {
    ...
    label: 'Qwen 3 Next 80B A3B Thinking (Preview)',
  ...
  },
  {
    ...
    label: 'Qwen 3 235B A22B (Preview)',
    description: "Qwen's advanced instruct LLM",
    vision: false,
    reasoning: false,
    experimental: false,
  ...
  },
  {
    ...
    label: 'Qwen 3 235B A22B Thinking (Preview)',
    description: "Qwen's advanced thinking LLM",
    vision: false,
    reasoning: true,
    experimental: false,
