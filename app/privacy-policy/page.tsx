    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="py-16 px-4">
        <div className="container max-w-3xl mx-auto prose dark:prose-invert prose-neutral prose-headings:font-be-vietnam-pro prose-p:text-muted-foreground prose-a:text-foreground prose-a:no-underline hover:prose-a:text-foreground/80 prose-headings:tracking-tight">
          <p className="text-lg">
            At AJ STUDIOZ, we respect your privacy and are committed to protecting your personal data. This Privacy Policy
          ...
          <p>
            <strong>Important Note on Payment Data:</strong> AJ STUDIOZ does not collect, store, or process any payment
          ...
          <p>
            <a href="mailto:support@ajstudioz.co.in" className="flex items-center gap-1">
              support@ajstudioz.co.in <ExternalLink className="h-4 w-4" />
            </a>
          </p>

          <div className="my-8 border-t pt-8">
            <p className="text-sm text-muted-foreground">
              By using AJ STUDIOZ, you agree to our Privacy Policy and our{' '}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <div className="text-sm text-muted-foreground">
                © {new Date().getFullYear()} AJ STUDIOZ
              </div>
            </div>
